      ...
      {isMobile && (
        <aside ref={drawerRef}
          ...
          <div style={{ marginTop:'auto', background:'rgba(255,255,255,0.08)', borderRadius:12, padding:'12px 10px', display:'flex', alignItems:'center', gap:10 }}>
            <div style={{ width:36, height:36, borderRadius:'50%', background:'linear-gradient(135deg,#00b1b4,#00d4ff)', display:'flex', alignItems:'center', justifyContent:'center', color:'#fff', fontWeight:700, flexShrink:0 }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:12 }}>
            ...
            {isMobile && (
              <button onClick={() => setDrawerOpen(true)}
                style={{ display:'flex', flexDirection:'column', justifyContent:'center', gap:5,
